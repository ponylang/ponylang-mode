...
- Fixed default-directory ([PR #152](https://github.com/ponylang/ponylang-mode/pull/152))
...
- Added struct support for ctags ([PR #132](https://github.com/ponylang/ponylang-mode/pull/132))
- Added addressof keyword highhighting ([PR #134](https://github.com/ponylang/ponylang-mode/pull/134))
...
- Simplified regular expression for indentation ([PR #129](https://github.com/ponylang/ponylang-mode/pull/129))
...
- Fixed match indent to be consistent with Style Guide ([PR #121](https://github.com/ponylang/ponylang-mode/pull/121))
...
- Fixed methods nesting highlighting ([PR #108](https://github.com/ponylang/ponylang-mode/pull/108))
...
- Added pony file coding system ([PR #105](https://github.com/ponylang/ponylang-mode/pull/105))
- Added fill column indicator ([PR #106](https://github.com/ponylang/ponylang-mode/pull/106))
- Added rainbow brackets highlighting ([PR #107](https://github.com/ponylang/ponylang-mode/pull/107))
